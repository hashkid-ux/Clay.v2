  ...
  return (
    <div className={fullWidth ? 'w-full' : ''}>
      ...
      <div className="relative">
        ...
        />
        {error && <AlertCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-red-600" />}
        {!error && success && <CheckCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-600" />}
      </div>
  ...
  return (
    <div className="flex items-start gap-3">
      <input
        ...
        disabled={disabled}
        className={`mt-1 rounded border-gray-300 ${disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
      />
      <div>
